...
public class SystemTest {
    ...
    public void SystemTest1() {
        ...
        csvcomparer.generate_csv_file(exceptions);
        ...
        String result = csvcomparer.read_csv_file("/Users/lmr/Desktop/Output/compare_output.csv").toString();
    ...
    //5. At least one of the input csv files has no entry
    @Test
