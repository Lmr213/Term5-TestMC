...
public class MyClass {
    ...
    public static void generate_csv_file(List<Map<String, String>> exceptions) {
        ...
        for (int i = 0; i < exceptions.size(); i++) {
            ...
            entryList.add(entryData.get("Customer ID#"));
            entryList.add(entryData.get("Account No."));
            entryList.add(entryData.get("Currency"));
            entryList.add(entryData.get("Type"));
            entryList.add(entryData.get("Balance"));
