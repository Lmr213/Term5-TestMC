...
public class SystemTest_YangHaocheng {

    // 1.Two input csv files have different number of entries
    @Test
    public void SystemTest1() {
        csvComparer csvcomparer = new csvComparer();
        List<List<String>> list1 = csvcomparer.read_csv_file_yhc("/Users/lmr/Desktop/Week9 csvfiles/class3/class3_middle1.csv");
        List<List<String>> list2 = csvcomparer.read_csv_file_yhc("/Users/lmr/Desktop/Week9 csvfiles/class3/class3_middle2.csv");
        List<List<String>> exceptions = csvcomparer.compare_csv_file(list1, list2);

        csvcomparer.generate_csv_file_yhc(exceptions);
        ...
        String result = csvcomparer.read_csv_file_yhc("/Users/lmr/Desktop/Output/compare_output.csv").toString();
    ...
    public void SystemTest2() {
        csvComparer csvcomparer = new csvComparer();
        List<List<String>> list1 = csvcomparer.read_csv_file_yhc("/Users/lmr/Desktop/Week9 csvfiles/class4/class4_middle1.csv");
        List<List<String>> list2 = csvcomparer.read_csv_file_yhc("/Users/lmr/Desktop/Week9 csvfiles/class4/class4_middle2.csv");
        List<List<String>> exceptions = csvcomparer.compare_csv_file_yhc(list1, list2);
    ...
    public void SystemTest3() {
        csvComparer csvcomparer = new csvComparer();
        List<List<String>> list1 = csvcomparer.read_csv_file_yhc("/Users/lmr/Desktop/Week9 csvfiles/class5/class5_middle1.csv");
        List<List<String>> list2 = csvcomparer.read_csv_file_yhc("/Users/lmr/Desktop/Week9 csvfiles/class5/class5_middle2.csv");
        List<List<String>> exceptions = csvcomparer.compare_csv_file_yhc(list1, list2);
